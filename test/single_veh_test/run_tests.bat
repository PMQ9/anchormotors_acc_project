@echo off
REM =========================================================================
REM Headless Test Runner for Single Vehicle Test Cases
REM =========================================================================
REM Description:
...
REM
REM Output:
REM   - Results saved to: test\single_veh_test\results\
...
matlab -batch "try, cd('%MATLAB_PROJECT_DIR%'); disp(['Current directory set to: ', pwd]); addpath('%MATLAB_SCRIPT_DIR%'); run_all_single_test; catch e, disp(['Error: ', e.message]); exit(1); end; exit;"
