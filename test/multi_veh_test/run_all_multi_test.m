...
% Define default simulation time and exceptions
defaultStopTime = '20';                   % Default simulation time in seconds
longRunStopTime = '50';                  % Stop time for long-running oscillation models

% Oscillation test models (50-second runs)
oscillationModels = { ...
    'case_25_mode0_lead_oscillates_1', ...
    'case_26_mode0_lead_oscillates_2', ...
    'case_27_mode0_lead_oscillates_3', ...
    'case_28_mode0_lead_oscillates_4', ...
    'case_29_mode0_lead_oscillates_5', ...
    'case_30_mode0_lead_oscillates_6', ...
    'case_31_mode0_lead_oscillates_7', ...
    'case_32_mode0_lead_oscillates_8', ...
    'case_33_mode0_lead_oscillates_9', ...
    'case_34_mode0_lead_oscillates_10', ...
    'case_35_mode0_lead_oscillates_11', ...
    'case_36_mode0_lead_oscillates_12', ...
    'case_37_mode0_lead_oscillates_13', ...
    'case_38_mode0_lead_oscillates_14', ...
    'case_39_mode0_lead_oscillates_15', ...
    'case_40_mode2_lead_oscillates_1', ...
    'case_41_mode2_lead_oscillates_2', ...
    'case_42_mode2_lead_oscillates_3', ...
    'case_43_mode2_lead_oscillates_4', ...
    'case_44_mode2_lead_oscillates_5', ...
    'case_45_mode2_lead_oscillates_6', ...
    'case_46_mode2_lead_oscillates_7', ...
    'case_47_mode2_lead_oscillates_8', ...
    'case_48_mode2_lead_oscillates_9', ...
    'case_49_mode2_lead_oscillates_10', ...
    'case_50_mode2_lead_oscillates_11', ...
    'case_51_mode2_lead_oscillates_12', ...
    'case_52_mode2_lead_oscillates_13', ...
    'case_53_mode2_lead_oscillates_14', ...
    'case_54_mode2_lead_oscillates_15', ...
    'case_55_mode2_lead_oscillates_16', ...
    'case_56_mode2_lead_oscillates_17', ...
    'case_57_mode2_lead_oscillates_18', ...
    'case_58_mode2_lead_oscillates_19', ...
    'case_59_mode2_lead_oscillates_20', ...
    'case_60_mode2_lead_oscillates_21', ...
    'case_61_mode2_lead_oscillates_22', ...
    'case_62_mode2_lead_oscillates_23', ...
    'case_63_mode2_lead_oscillates_24', ...
    };

% Approach test models (50-second runs) - ego approaches slow lead from far away
approachModels = { ...
    'case_77_mode_0_slow_but_far', ...
    'case_78_mode_012_approach_far_away_car', ...
    };

% Comprehensive long-run test model (850 seconds)
% Combines: Mode 0 stable, Mode 2 stable, into-wave, out-of-wave, and cut-in scenarios
ultraLongRunModels = { ...
    'case_79_long_full_test', ...
    };
ultraLongRunStopTime = '850';            % Stop time for ultra-long comprehensive tests

% Combine all long-run models
longRunModels = [oscillationModels, approachModels, ultraLongRunModels];
...
for k = 1:numel(modelFiles)
    ...
    try
        ...
        if ismember(modelName, longRunModels)
            stopTime = longRunStopTime;
            fprintf('Using long run time (%s seconds) for model: %s\n', longRunStopTime, modelName);
        else
            stopTime = defaultStopTime;
            fprintf('Using default run time (%s seconds) for model: %s\n', defaultStopTime, modelName);
        end

        % Run simulation (normal mode so disp() messages appear)
        simOut = sim(modelName, 'SimulationMode', 'normal', 'StopTime', stopTime);
