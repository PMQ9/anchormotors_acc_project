...
class ACCParameters:
    ...
    # State 0: No Wave
    alpha_no_wave: float = 0.6250
    tau_no_wave: float = 2.0460
    beta_no_wave: float = 0.2110
    ...
    # State 2: In Wave
    alpha_in_wave: float = 0.6460
    tau_in_wave: float = 2.2530
    beta_in_wave: float = 0.2130
